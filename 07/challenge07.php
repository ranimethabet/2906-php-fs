...
// Function call:
 ...
 fullName(first: 'John', lName:'Doe');
 fullName(first:'Sara', lName: 'Smith');
...
function movie(string$movie,string$year):void
{
    ...
    echo($year>=2000)?"Movie:$movie,Year:$year,it is a new movie <hr/>":"Movie:$movie,Year:$year,it is an old movie <hr/>";
}
// Function call:
